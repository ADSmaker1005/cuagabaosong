        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0">Banner</h5>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="locate">
                                        ...
                                        <option value="1">Trang chủ phần đầu bên trái</option>
                                        <option value="2">Trang chủ phần đầu bên phải</option>
                                        <option value="3">Trang chủ banner</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
